...
export default function Home() {
    ...
    return (
        <main className="bg-gray-800 flex flex-col justify-center items-center min-h-screen p-10 md:p-24">
            ...
            <div className="flex flex-col gap-6 w-full max-w-xl">
                ...
                <div className="border border-gray-600 rounded-lg p-8 flex-1 text-center">
                    ...
                    <a href="https://donate.stripe.com/bIY9CAfTh5IweDmfZm"><button className="mt-4 bg-blue-600 hover:bg-blue-800 text-white py-2 px-4 rounded-md">捐赠
                    </button></a>
                </div>
            </div>
        </main>
